        ...
        <>
          <div className="absolute top-1/2 left-[60%] -translate-x-1/2 -translate-y-1/2">
            <div className="relative h-[22rem] w-[22rem]">
              <div className="absolute inset-0 rounded-full bg-[radial-gradient(circle,var(--wave-a),var(--wave-b),var(--wave-c),rgba(0,0,0,0.9))] shadow-[0_0_20px_rgba(0,0,0,0.35)] animate-vinyl-spin" />
