        ...
        <>
          <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
            <div className="relative flex items-center justify-center">
              <div className="absolute aspect-square size-[clamp(16rem,35vw,22rem)] -translate-x-[65%]">
              ...
              <img
                ...
                className="relative z-10 aspect-square size-[clamp(16rem,35vw,22rem)] translate-x-[35%] rounded-none object-cover shadow-[0_0_20px_rgba(0,0,0,0.35)]"
              />
            </div>
          </div>
        </>
